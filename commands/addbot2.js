module.exports.awaitedCommand = {
  ...
  code: `$channelSendMessage[logchannel; <@$getMessageVar[userid]> {title: Declined!} {description: **$userTag[$getMessageVar[clinetid;$messageID]]** Has been **declined** by $userTag for one of the reasons below.
